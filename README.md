...
This is a personal project with notes on web development


## Roadmap

- Markup: [Vue](https://vuejs.org) + [Vite](https://vitejs.dev) + [Router](https://router.vuejs.org) + [Pinia](https://pinia.vuejs.org/)
